 ...
 */
public class ReplaceBatchInto extends AbstractMethod {
    private static final String MAPPER_METHOD = "replaceBatchInto";
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        return this.addInsertMappedStatement(mapperClass, modelClass, "replaceBatchInto", sqlSource, (KeyGenerator)keyGenerator, keyProperty, keyColumn);
    }

    public ReplaceBatchInto() {
    }

    public ReplaceBatchInto(final Predicate<TableFieldInfo> predicate) {
        this.predicate = predicate;
    }

    public ReplaceBatchInto setPredicate(final Predicate<TableFieldInfo> predicate) {
        this.predicate = predicate;
        return this;
    }
}