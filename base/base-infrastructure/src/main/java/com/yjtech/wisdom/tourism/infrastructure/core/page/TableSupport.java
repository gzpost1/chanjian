package com.yjtech.wisdom.tourism.infrastructure.core.page;
...
public class TableSupport {
  ...
  public static <T> IPage<T> buildIPageRequest() {
    ...
    Page<T> page = new Page<T>(pageDomain.getPageNum(), pageDomain.getPageSize());
    // TODO: 2020/9/7 增加排序
