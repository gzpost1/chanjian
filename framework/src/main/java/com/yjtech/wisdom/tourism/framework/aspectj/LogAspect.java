package com.yjtech.wisdom.tourism.framework.aspectj;

import com.alibaba.fastjson.JSON;
import com.yjtech.wisdom.tourism.common.annotation.Log;
import com.yjtech.wisdom.tourism.common.enums.BusinessStatus;
...
public class LogAspect {
  ...
  // 配置织入点
  @Pointcut("@annotation(com.yjtech.wisdom.tourism.common.annotation.Log)")
  ...
  protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
    try {
      // 获得注解
      com.yjtech.wisdom.tourism.common.annotation.Log controllerLog = getAnnotationLog(joinPoint);
  ...
  public void getControllerMethodDescription(
      JoinPoint joinPoint, com.yjtech.wisdom.tourism.common.annotation.Log log, SysOperLog operLog)
      throws Exception {
    // 设置action动作
  ...
  /** 是否存在注解，如果存在就获取 */
  private com.yjtech.wisdom.tourism.common.annotation.Log getAnnotationLog(JoinPoint joinPoint)
      throws Exception {
