...
import com.yjtech.wisdom.tourism.framework.security.filter.JwtAuthenticationTokenFilter;
import com.yjtech.wisdom.tourism.framework.security.handle.AuthenticationEntryPointImpl;
import com.yjtech.wisdom.tourism.framework.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/login", "/captchaImage","/video/downloadExcel","/project/getTemplate","/screen/statistics/**")
                .anonymous()
                ...
                .anonymous()
                .antMatchers("/common/download/resource**")
                .anonymous()
