package com.yjtech.wisdom.tourism.wechat.wxpay.converter;

import com.yjtech.wisdom.tourism.wechat.wxpay.bean.notify.WxPayOrderNotifyCoupon;
...
public class WxPayOrderNotifyResultConverter extends AbstractReflectionConverter {
  ...
  private void setFieldValue(UnmarshallingContext context, WxPayOrderNotifyResult obj,
      Field field) {
  ...
  private WxPayOrderNotifyCoupon getElement(Map<Integer, WxPayOrderNotifyCoupon> coupons,
      String nodeName) {
