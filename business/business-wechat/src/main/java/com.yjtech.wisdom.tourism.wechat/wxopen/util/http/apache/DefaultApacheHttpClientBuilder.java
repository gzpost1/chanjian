package com.yjtech.wisdom.tourism.wechat.wxopen.util.http.apache;
...
public class DefaultApacheHttpClientBuilder implements ApacheHttpClientBuilder {
  ...
  private SSLConnectionSocketFactory sslConnectionSocketFactory = SSLConnectionSocketFactory
      .getSocketFactory();
  private PlainConnectionSocketFactory plainConnectionSocketFactory = PlainConnectionSocketFactory
      .getSocketFactory();
  ...
  @Override
  public ApacheHttpClientBuilder sslConnectionSocketFactory(
  ...
  private synchronized void prepare() {
    ...
    if (StringUtils.isNotBlank(this.httpProxyHost) && StringUtils
        .isNotBlank(this.httpProxyUsername)) {
