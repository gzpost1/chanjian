...
import com.yjtech.wisdom.tourism.scheduler.mapper.SysJobMapper;
import com.yjtech.wisdom.tourism.scheduler.util.CronUtils;
import com.yjtech.wisdom.tourism.scheduler.util.ScheduleUtils;
...
public class SysJobService {
  ...
  public IPage<SysJob> selectJobList(SysJob job) {
    IPage<SysJob> pageDomain = TableSupport.buildIPageRequest();
    return jobMapper.selectJobList(pageDomain, job);
  }
