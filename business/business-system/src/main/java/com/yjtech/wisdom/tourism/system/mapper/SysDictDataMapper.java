...
public interface SysDictDataMapper {
     ...
     * @return 字典数据集合信息
     */
    public IPage<SysDictData> selectDictDataList(IPage<SysDictData> page, @Param("args") SysDictData dictData);
     ...
     * @return
     */
    public List<SysDictData> selectDictDataListWithoutPage(@Param("args") SysDictData dictData);
