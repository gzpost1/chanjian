...
public class SysDictDataService {
     ...
     * @return
     */
    public Multimap<String, SysDictData> selectDictDataListWithoutPage(SysDictData dictData) {
        List<SysDictData> list = dictDataMapper.selectDictDataListWithoutPage(dictData);
        Multimap<String, SysDictData> result = ArrayListMultimap.create();
        for (SysDictData sysDictData : list) {
            result.put(sysDictData.getDictType(), sysDictData);
        }
        return result;
    }
}
